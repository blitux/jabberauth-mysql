...
HEADER_MSG : 'Datos no válidos:',
FOOTER_MSG : 'por favor, int&eacute;ntelo otra vez.',
DEFAULT_MSG : 'el dato no es válido.',
REQUIRED_MSG : 'Campo requerido',
ALPHABETIC_MSG : '{1} no es válido. Caracteres permitidos: A-Za-z',
ALPHANUMERIC_MSG : '{1} no es válido. Caracteres permitidos: A-Za-z0-9',
ALNUMHYPHEN_MSG : 'Caracter no válido. Se permite: A-Za-z0-9\-_',
ALNUMHYPHENAT_MSG : '{1} no es válido. Caracteres permitidos: A-Za-z0-9\-_@',
ALPHASPACE_MSG : '{1} no es válido. Caracteres permitidos: A-Za-z0-9\-_espacio',
MINLENGTH_MSG : 'Debe tener {2} caracteres mínimo',
...
INTEGER_MSG : '{1} debe ser un número entero.',
DOUBLE_MSG : '{1} debe ser un número decimal.',
REGEXP_MSG : '{1} no es válido. El formato permitido es {2}.',
...
EMAIL_MSG : 'Dirección de email no válida',
